...
rmdir /S /Q onscripter\Debug onscripter\Release 
del /Q onscripter\*.plg onscripter\*.ncb onscripter\*.opt onscripter\*.aps

rmdir /S /Q SDL\Debug SDL\Release 
del /Q SDL\*.plg SDL\*.ncb SDL\*.opt SDL\*.aps 

rmdir /S /Q SDL_image\Debug SDL_image\Release 
del /Q SDL_image\*.plg SDL_image\*.ncb SDL_image\*.opt SDL_image\*.aps

::rmdir /S /Q SDL_mixer\Debug SDL_mixer\Release 
::del /Q SDL_mixer\*.plg SDL_mixer\*.ncb SDL_mixer\*.opt SDL_mixer\*.aps

rmdir /S /Q SDL_ttf\Debug SDL_ttf\Release 
del /Q SDL_ttf\*.plg SDL_ttf\*.ncb SDL_ttf\*.opt SDL_ttf\*.aps
